...
export default function AdminSideBar() {
    ...
    return (
        <div>
            <div
                className="fixed top-0 left-0 w-full bg-white h-14 border-b border-orange-100 flex items-center justify-between px-4 md:px-6 ">
            ...
            <div
                className={` fixed top-0 left-0 w-64  h-full border-r transform     bg-white   ${
                    isSidebarOpen ? "translate-x-0" : "-translate-x-full"
                } md:translate-x-0 transition-transform duration-300 ease-in-out z-40`}
            >
                <div className="flex items-center p-5 space-x-20 h-14 border-b">
                    <div className={"font-bold text-xl text-accentOrange gap-3 flex"}><Smile/>Homely</div>
                    <div
                        onClick={toggleSidebar}
                        className="flex items-center px-4 py-2 text-gray-800  justify-items-start   "
                    >
                        <ArrowLeft className="w-5 h-5 mr-2 md:hidden hover:bg-gray-100"/>
