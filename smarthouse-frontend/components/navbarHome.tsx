...
export default function Navbar() {
    ...
    function DropdownItems({mobile = false}: { mobile?: boolean }) {
        return <>
            ...
            <DropdownMenuItem className={`${mobile ? "text-lg" : ""}`} onClick={() => {
            }}>
                {/*{theme === 'dark' ? <Sun className="h-4 w-4 mr-2" /> : <Moon className="h-4 w-4 mr-2" />}*/}
                {true ? <Sun className="h-4 w-4 mr-2"/> : <Moon className="h-4 w-4 mr-2"/>}
                Toggle Theme
            </DropdownMenuItem>
                    ...
                    <Sheet open={isOpen} onOpenChange={setIsOpen}>
                        ...
                        >
                            ...
                            <div className="flex flex-col items-start space-y-4 mt-8">
                                {/* Pass `w-full` for full-width stretching */}
                                ...
                                >
                                    {true ? <Sun className="h-5 w-5 mr-2"/> : <Moon className="h-5 w-5 mr-2"/>}
                                    Toggle Theme
                                </Button>
